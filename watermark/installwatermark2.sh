        ...
        <div class="box box-info">
            <div class="box-body text-center">
                <h4 style="margin: 10px 0;">
                    <i class="fa fa-eye"></i> 
                    Anda pengunjung ke: 
                    <strong id="visitorCount" style="color: #3c8dbc;">0</strong>
                </h4>
                <p class="text-muted" style="margin: 5px 0 10px 0;">
                    <small>Session hari ini: <span id="todayVisitors">0</span></small>
                </p>
            </div>
        </div>
    </div>
...
(function() {
  ...
  function updateClock() {
    ...
    // Simple visitor counter menggunakan localStorage
    ...
    animateCounter(document.getElementById('visitorCount'), totalVisits);
    animateCounter(document.getElementById('todayVisitors'), todayVisits);
