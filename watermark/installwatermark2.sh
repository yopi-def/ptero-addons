...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-share-alt"></i> Connect With Us</h3>
            </div>
            <div class="box-body text-center">
                <a href="#" class="btn btn-social-icon btn-facebook" title="Facebook">
                    <i class="fa fa-facebook"></i>
                </a>
                <a href="#" class="btn btn-social-icon btn-twitter" title="Twitter">
                    <i class="fa fa-twitter"></i>
                </a>
                <a href="#" class="btn btn-social-icon btn-instagram" title="Instagram">
                    <i class="fa fa-instagram"></i>
                </a>
                <a href="#" class="btn btn-social-icon btn-github" title="GitHub">
                    <i class="fa fa-github"></i>
                </a>
                <a href="#" class="btn btn-social-icon btn-youtube" title="YouTube">
