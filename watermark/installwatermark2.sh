...
<div id="qrisModal" class="modal-overlay" role="dialog" aria-labelledby="modalTitle" aria-modal="true">
    <div class="modal-content" role="document">
        ...
        <img src="https://raw.githubusercontent.com/yopi-def/database/refs/heads/main/picture/qris.jpg"
             alt="QRIS Code"
             class="qris-image"
             loading="lazy">
        
        <a href="https://raw.githubusercontent.com/yopi-def/database/refs/heads/main/picture/qris.jpg"
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="btn-group-wrapper">
                    ...
                    <a href="{{ route('admin.locations') }}" class="quick-btn">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body text-center">
                <div class="media-container">
                    <video id="autoVideo"
                        src="https://raw.githubusercontent.com/yopi-def/database/refs/heads/main/picture/84857c6fb0e7d00369c92a276e786c32.mp4"
                        autoplay
                        loop
                        muted
                        playsinline
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <div class="box-body text-center">
                <div class="media-container">
                    <img src="https://raw.githubusercontent.com/yopi-def/database/refs/heads/main/picture/81a88cbdac646a7a9f38ba7fd719bd4e.jpg"
                         alt="Profile Image"
                         loading="lazy">
                </div>
            </div>
