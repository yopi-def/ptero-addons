...
<div class="row">
    <div class="col-xs-12">
        <div class="alert" id="greetingAlert" style="border-left: 5px solid #3c8dbc;">
            <h4 style="margin-top: 0;">
                <i class="fa fa-smile-o"></i> 
                <span id="greetingText">Selamat Datang</span>, 
                <strong>{{ Auth::user()->name_first ?? 'Admin' }}</strong>! 
            </h4>
            <p id="greetingMessage">Semoga hari Anda menyenangkan!</p>
        </div>
    </div>
</div>
  ...
  function updateClock() {
    ...
    function updateGreeting() {
        ...
        if (hour >= 5 && hour < 11) {
            ...
            greetingMessage.textContent = 'Semangat memulai hari yang produktif!';
            greetingAlert.style.background = '#d4edda';
            greetingAlert.style.borderLeftColor = '#28a745';
        } else if (hour >= 11 && hour < 15) {
            greetingText.textContent = 'Selamat Siang';
            greetingMessage.textContent = 'Jangan lupa istirahat sejenak ya!';
            greetingAlert.style.background = '#fff3cd';
            greetingAlert.style.borderLeftColor = '#ffc107';
        } else if (hour >= 15 && hour < 18) {
            greetingText.textContent = 'Selamat Sore';
            greetingMessage.textContent = 'Hampir selesai, tetap semangat!';
            greetingAlert.style.background = '#ffeeba';
            greetingAlert.style.borderLeftColor = '#ff9800';
        } else {
            greetingText.textContent = 'Selamat Malam';
            greetingMessage.textContent = 'Waktunya istirahat, jangan begadang!';
            greetingAlert.style.background = '#cce5ff';
            greetingAlert.style.borderLeftColor = '#004085';
        }
    }
