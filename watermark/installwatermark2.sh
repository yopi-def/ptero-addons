            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-3 col-xs-6">
                        <a href="{{ route('admin.servers') }}" class="btn btn-app" style="width: 100%;">
                            <i class="fa fa-server"></i> Servers
                        </a>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <a href="{{ route('admin.users') }}" class="btn btn-app" style="width: 100%;">
                            <i class="fa fa-users"></i> Users
                        </a>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <a href="{{ route('admin.nodes') }}" class="btn btn-app" style="width: 100%;">
                            <i class="fa fa-sitemap"></i> Nodes
                        </a>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <a href="{{ route('admin.settings') }}" class="btn btn-app" style="width: 100%;">
